...
In addition to the standard SublimeLinter settings, SublimeLinter-eslint provides its own settings. Those marked as “Inline Setting” or “Inline Override” may also be [used inline][inline-settings].
